 ...
 *
 * The concrete implementation must override the send method and implement readSignals
 * and stream static methods.
 */
export abstract class ServerSentEventGenerator {
   ...
   *
   * Implementations should override this method by calling the parent function
