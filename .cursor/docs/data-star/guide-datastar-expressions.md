...
[STOP OVERCOMPLICATING IT](https://data-star.dev/guide/stop_overcomplicating_it)
...
*   [Basic Usage](https://data-star.dev/guide/datastar_expressions#basic-usage)
    
*   [Namespaced Signals](https://data-star.dev/guide/datastar_expressions#namespaced-signals)
    
*   [Multiple Statements and Formatting](https://data-star.dev/guide/datastar_expressions#multiple-statements-and-formatting)
    
*   [Event Context](https://data-star.dev/guide/datastar_expressions#event-context)
    
*   [Summary](https://data-star.dev/guide/datastar_expressions#expression-summary)
...
Note that `data-*` attributes are evaluated in the order they appear in the DOM, so the `data-text` attributes must come _after_ the `data-signals-*` attributes in the example above. See the [attribute plugins reference](https://data-star.dev/reference/attribute_plugins)
...
Expression Summary[#](https://data-star.dev/guide/datastar_expressions#expression-summary)
...
*   **Actions:** [Actions](https://data-star.dev/reference/action_plugins)
     are called using the `@` prefix (e.g., `@post('/endpoint')`).
